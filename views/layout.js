...
export class Layout {
    ...
    constructor(router) {
        ...
        // 모바일 드로어
        const drawerMenu = el('sl-menu', el('sl-menu-item', '탐색', { 'data-key': 'explore' }), el('sl-menu-item', '내 NFT', { 'data-key': 'my-items' }), el('sl-menu-item', '히스토리', { 'data-key': 'history' }));
